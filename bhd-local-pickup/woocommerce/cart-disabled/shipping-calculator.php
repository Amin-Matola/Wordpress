...
$cog_icon 		= !empty($cog_icon)? $cog_icon : "chevron-down";
$cog_text 		= $cog_text."&nbsp;<i class='fa fa-$cog_icon'></i>";
do_action( 'woocommerce_before_shipping_calculator' ); ?>

<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">


	<!-------------- Check if cog shipping calculator function was called ------------------>
	<?php printf( '<a href="#" class="shipping-calculator-button">%s</a>', 
					! empty( $button_text ) ? esc_html__($button_text) : !empty($cog_text)? $cog_text : esc_html__(__( 'Calculate shipping', 'woocommerce' ) ) ); ?>
	<?= wc_price(100, ["currency"=>"MWK"]); ?>
