...
<table class="shop_table woocommerce-checkout-review-order-table">
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					<td class="product-thumbnail">
						<?= 
						// custom image fields
						$_product->get_image(apply_filters( 'single_product_archive_thumbnail_size', [80,0] )); ?>
					</td>
	...
	<tfoot>
		<tr >
			...
			<th colspan="2" style="border-top: 1px solid lightgrey">
				<p class="form-row form-row-first" style="width:100%">
						<input type="text" name="coupon_code" class="input-text" placeholder="Gift card or discount code" id="coupon_code" value="">
				</p>
			</th>
			<td style="border-top: 1px solid lightgrey !important">
				<p class="form-row form-row-last" style="width:100%">
					<button type="submit" class="button" name="apply_coupon" value="Apply">Apply</button>
				</p>				
			</td><?php //do_action( 'woocommerce_before_checkout_form', $checkout ); ?>
		</tr>
		...
		<?php if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : ?>
            ...
            <tr class="woocommerce-shipping-totals shipping">
                ...
                <td class="bee-woo-shipping-cost">
                    <?php echo count(WC()->session->get('chosen_shipping_methods'))? WC()->cart->get_cart_shipping_total() : __("Calculated at next step", "woocommerce"); ?>
                </td>
            </tr>
